    ...
    const cardFlipped = () => {
        return (
            <div 
                ...
                className="animate-[flip_0.2s_forwards] w-full h-32 sm:h-36 rounded-md"
            />
        )
    }
    ...
    const cardNotFlipped = () => {
        return (
            <div
                ...
                className="animate-[flip_0.2s_forwards] w-full h-32 sm:h-36 bg-white/20 flex justify-center hover:cursor-pointer hover:shadow-lg rounded-md"
            >
                <QuestionOutlined className="text-5xl" style={{transform: "rotateY(180deg)"}} />
            </div>
        )
    }
    return(
